...
**Governance status.** `REG-0036` is `IMPLEMENTED`. The exact bounded unit is `COMPLETE`, verified at commit `466d48ac8f8a2883c8eb459fb7bfa37213d228bf` (`feat: add inert authentication session persistence`) within the exact four-file boundary below. `REG-0035`/accepted `ADR-0016` remain the unchanged physical authority; no `ADR-0017` is required or allocated.
